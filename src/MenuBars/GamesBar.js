    ...
    useEffect(() => {
        const fetchStandings = async () => {
            try {
                ...
                var scheduleData = [];
                var gamesData = [];
                const response = await axios.get('https://wild-puce-seagull-gown.cyclic.app/schedule/' + selectedDate.toISOString().slice(0, 10)); //'https://wild-puce-seagull-gown.cyclic.app/standings/'
